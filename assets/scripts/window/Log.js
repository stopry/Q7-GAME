...
cc.Class({
    ...
    getLogData(){//得到日志数据
        ...
        var self = this;
        Net.get('/game/log/list',1,{pageNum:self.curPageNum},function(data){
            if(!data.success){
    ...
    //        Net.get('/game/log/empty',1,null,(data)=>{
    //            if(!data.success){
    //                this.showLittleTip(data.msg);
    //            }else{
